...
export const SpecHs = 1; // hs rule name list
export const SpecPart = 2; // part rule name list
export const all = 99; //上传页面list中下拉默认传值99
...
export const downloadUrl = 'http://115.28.203.39:9091/Excel/' // 下载文件路径
export const templateUrl = 'http://115.28.203.39:9091/Template/Template.xlsx' // 上传模板文件路径
export const apiImport = 'Request/ImportExcel' //导入Excel数据接口
